		...
		<li class="statics">
			...
			<ul>
				<li>
					...
					<ul>
						<li>
							<a href="/statics/vis/conc">Concentrated Loads </a>
						</li>
						<li>
							<a href="/statics/vis/dist">Distributed Loads </a>
						</li>
						<li>
							<a href="/statics/vis/moj">Method of Joints: Bridge</a>
						</li>
					</ul>
				</li>

				<li>
					<a href="/statics/guided"><s>Guided Practice</s></a>
					<ul>
						<li>
